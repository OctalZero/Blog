...
const BLOG = {
  ...
  // Waline 评论插件
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://comment.octalzero.com', // Waline 评论 @see https://waline.js.org/guide/get-started.html
